...
def preprocess_data(data, test_size=0.2, output_dir=None):
    ...
    if output_dir:
        ...
        logger.info(f"Saved training data to {os.path.join(output_dir, 'train.csv')}")
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                      default=os.path.join(file_dir, "..", "data", "processed"),
                      help='Directory to save training data')
    parser.add_argument('--model_type', type=str,
                      default="random_forest",
                      help='Type of model to train (random_forest or linear)')
    ...
    try:
        ...
        X_train, X_test, y_train, y_test, preprocessor = preprocess_data(
            data, args.test_size, args.output_dir
        )
